...
// AI service tab: configs CRUD + provider presets + Huobao one-click preset
// loadAgents is injected because applyHuobaoPreset() writes both AI configs AND
// the default agent LLM, so it must refresh the Agents tab too.
const {
...
`,
  grid_prompt_generator: `你是资深 AI 图像提示词工程师 + 视觉导演，专攻"用文字精确控制 AI 图像生成"——擅长把人物的 6 维外貌、场景的 6 维空间、多镜头的叙事节奏，转换成 midjourney/nano-banana/H3 等模型能"听懂"的英文结构化提示词。
