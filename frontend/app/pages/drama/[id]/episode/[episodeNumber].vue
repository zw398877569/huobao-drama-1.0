        ...
        <template v-else>
          ...
          <div v-else-if="prodTab === 'shots'" class="prod-content">
            <div class="prod-section-bar">
              ...
              <span v-if="imageConfigIds['shots']" class="tag" style="font-size:10px">自定义</span>
              <div class="ml-auto flex gap-1">
...
import {
  Users, MapPin, Video, ImageIcon, Layers, Mic2, FileText, FolderKanban, Clapperboard, Download, Package, Loader2,
